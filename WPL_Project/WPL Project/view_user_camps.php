...
if ($_SERVER ["REQUEST_METHOD"] == "GET") {
	...
	$sql = "SELECT t1.camp_id, t1.camp_name,t1.cost,t1.start_date,t1.end_date from camps_db as t1,user_camps_db as t2 where t1.camp_id = t2.camp_id and t2.username ='".$username."'";
