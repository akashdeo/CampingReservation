        ...
        $(document).ready(function(){
            ...
            $.ajax({
                ...
                success:function(cart){
                    ...
                    $('#res-cart').empty();
                    $('#res-cart').html('<tr><th>Camp ID</th><th>Camp Name</th><th>Start Date</th><th>End Date</th></tr>');

                    for(var i = 0; i < cart.length; i++){
                        
                        $('#res-cart').append('<tr><td>'+cart[i]['camp_id']+'</td><td>'+cart[i]['camp_name']+'</td><td>'+cart[i]['start_date']+'</td><td>'+cart[i]['end_date']+'</td><td><button class="btn btn-primary">Remove From Cart</button></td></tr>');
                    }
