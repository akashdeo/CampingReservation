    ...
    <script>
        ...
        $.ajax({
            ...
            success:function(campList){
                ...
                $('#res-gen-search').html('<tr><th>Camp_ID</th><th>Camp Name</th><th>Cost</th><th>Start Date</th><th>End Date</th></tr>');
                for(var i = 0; i < campList.length; i++){
                    $('#res-gen-search').append('<tr><td>'+campList[i]['camp_id']+'</td><td>'+campList[i]['camp_name']+'</td><td>'+campList[i]['cost']+'</td><td>'+campList[i]['start_date']+'</td><td>'+campList[i]['end_date']+'</td></tr>');
                }
                $('#res-gen-search').show();
            },
            error:function(){
